...
import { DemoModal } from "../../components/ui/JoinOurProgramModal";
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 items-center gap-8 px-6 sm:px-12 lg:px-32">
          <div className="lg:col-span-9 flex flex-col justify-center gap-y-6 text-left">
            ...
            <div className="pt-4">
              {/* ✅ FIXED: Button now opens modal instead of navigating */}
              <button
                onClick={openModal}
                className="inline-block bg-active-blue text-white text-[16px] font-bold font-roboto px-8 py-4 rounded-xl shadow-lg hover:bg-opacity-90 transition-colors cursor-pointer"
                style={{ 
