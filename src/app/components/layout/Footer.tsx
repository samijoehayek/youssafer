...
import { DemoModal } from '../../components/ui/PartnerModal';
          ...
          <div className="space-y-16">
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-16 md:gap-32 mb-24">
              <div className="flex-1 max-w-2xl mb-20">
                ...
                <button 
                  onClick={openModal}
                  className="rounded-lg bg-white py-3 px-6 font-semibold text-black transition-colors hover:bg-gray-200 cursor-pointer"
                >
                  Get Started
                </button>
              </div>
