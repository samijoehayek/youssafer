...
export const Footer: React.FC = () => {
  return (
    ...
    >
      ...
      {/* ✅ CHANGED: Increased max-width from xl to 2xl for a wider layout */}
      <div className="relative z-20 mx-auto max-w-screen-2xl px-4 pt-24 pb-16 sm:px-8">
        {/* Row 1: Newsletter */}
        ...
        <div className="space-y-16">
          ...
          {/* Partner and Contact on a two-column row */}
          <div className="grid grid-cols-1 items-start gap-16 md:grid-cols-2">
            <div>
              <h3 className="mb-4 font-poppins text-3xl font-semibold md:text-4xl">Become a partner</h3>
            ...
            <div>
              <h3 className="mb-4 font-poppins text-3xl font-semibold md:text-4xl">Contact Us</h3>
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-3">
                  <Mail size={20} /> <span>contact@yousaffer.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone size={20} /> <span>+961 71 123 456</span>
                </div>
                <div className="flex items-center gap-3">
                  <MapPin size={20} /> <span>Beirut, Lebanon</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-24 border-t border-white/20"></div>
        ...
        <div className="flex flex-col items-center justify-between pt-8 text-sm text-white/70 sm:flex-row">
          ...
          <div className="mt-4 flex gap-5 sm:mt-0">
            <Twitter size={20} className="cursor-pointer transition-colors hover:text-white" />
            <Linkedin size={20} className="cursor-pointer transition-colors hover:text-white" />
            <Facebook size={20} className="cursor-pointer transition-colors hover:text-white" />
          </div>
        </div>
      </div>
    </footer>
